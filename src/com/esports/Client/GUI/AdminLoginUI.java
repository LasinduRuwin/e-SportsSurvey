...
/**
 * Login UI for accessing the Status UI
...
public class AdminLoginUI extends javax.swing.JFrame {
    ...
    private void Login_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Login_btnMouseClicked
        /**
         * Login Button:
         * Sends user name and password to the RMI server and get a validation and the sets a cookie
         */
        ...
        else
        {
            try {
                ...
                if(rmiserv.login(un, pw))
                {
                    ...
                    mx.setCookie(un);
                    //redirectiong to StatusUI
                    StatusUI nxt = new StatusUI();
                    setVisible(false);
                    nxt.setVisible(true);
                }
                else
