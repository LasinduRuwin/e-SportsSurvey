...
import com.esports.Client.cookie.AdmnCookie;

/**
 * This is first UI that a user will see
 * This UI will direct the users to the survey statistics pages
...
public class MainUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Startbtn1.setBackground(new java.awt.Color(255, 255, 255));
            ...
            .addGroup(HomeLayout.createSequentialGroup()
                ...
                .addGroup(HomeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(HomeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(Startbtn1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
...
//variables for XY coordinations of the window
    ...
    private void StartbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_StartbtnMouseClicked
            /**
             * Sends the user to Status UI if the user is logged in. 
             * otherwise it will send the user to Login screen.
             */
            String result;
            AdmnCookie mx = new AdmnCookie();
            result = mx.getCookie();
            if(result == null){
